 ...
 * 	这些数据是由不同的公司（厂商）来生产，开发的。
 * 	Java程序：去连接不同的数据库时，使用相同的代码。
 * 	Java连接和操作mysql数据库的代码同样可以用来连接和操作oracle数据库，sql server。
 * 	希望这个Javadiamante具有通用性，那么Java就要指定一个标准。
 * 
 ...
 * 	这些实现类，通过jar包更换就可以实现，而编程的代码中，面向接口编程
 * 
 * 2、现在我想设计一个数组的工具类MyArrays,这个工具类中有一个方法，可以为任意对象数组进行排序，从小到大排序。
...
public class TestInterface {
	...
	public static void main(String[] args) {
		String s1 = "hello";
		String s2 = "world";
//		System.out.println(s1 > s2);//对象不能直接比较大小
	}
